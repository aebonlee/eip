...
export default function CodingExercise() {
  ...
  const difficultyClass: Record<string, string> = { easy: 'difficulty-easy', medium: 'difficulty-medium', hard: 'difficulty-hard' }
  const difficultyLabel: Record<string, string> = { easy: '쉬움', medium: '보통', hard: '어려움' }
  const cardDifficultyClass: Record<string, string> = { easy: 'card-difficulty-easy', medium: 'card-difficulty-medium', hard: 'card-difficulty-hard' }
