    ...
    <div className="auth-page">
      <div className="login-card">
        <div style={{ marginBottom: 32 }}>
          <div style={{ width: 64, height: 64, background: 'var(--gradient-primary)', borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', color: 'white', fontWeight: 800, fontSize: 24 }}>
            EIP
          </div>
          <h1>로그인</h1>
