    ...
    <>
      ...
      <section className="hero">
        <div className="hero-particles">
          <div className="particle" style={{ width: 6, height: 6, top: '20%', left: '10%', '--duration': '15s', '--delay': '0s' }} />
          <div className="particle" style={{ width: 4, height: 4, top: '60%', left: '80%', '--duration': '20s', '--delay': '5s' }} />
          <div className="particle" style={{ width: 8, height: 8, top: '40%', left: '50%', '--duration': '18s', '--delay': '2s' }} />
          <div className="particle" style={{ width: 5, height: 5, top: '80%', left: '30%', '--duration': '22s', '--delay': '8s' }} />
          <div className="code-line" style={{ top: '15%', right: '5%', '--delay': '0s' }}>SELECT * FROM subjects</div>
          <div className="code-line" style={{ top: '45%', right: '10%', '--delay': '5s' }}>def solution(n):</div>
          <div className="code-line" style={{ top: '75%', right: '3%', '--delay': '10s' }}>int main() {'{'} return 0; {'}'}</div>
        </div>
